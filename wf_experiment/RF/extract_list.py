...
def parallel(para_list, n_jobs=32):
    pool = mp.Pool(n_jobs)
...
def process_dataset(file_name, suffix):
    output_dir = '../preprocessed_data/RF_features_h3' + '-' + suffix
...
if __name__ == '__main__':
    defence = 'Undefence'
    traces_path = '../preprocessed_data/RF_h3/'            # TODO: change to your dataset path

    feature_func = 'packets_per_slot'

    train_name = 'list/Index_train_h3.txt'
    test_name = 'list/Index_test_h3.txt'
